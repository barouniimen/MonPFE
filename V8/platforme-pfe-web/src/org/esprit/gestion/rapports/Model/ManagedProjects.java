...
public class ManagedProjects {
	...
	public ManagedProjects(int idPorj, String projTopic,
			ValidationState projState,
			String companyName, String coachName, String coachFirstName,
			String correctorName, String correctorFirstName,
			String companyCoachName, String companyCoachFirstName,
			String studentName, String studentFirstName, Date startDate, List<ProjectDomain> projDomainList) {
		super();
		this.idPorj = idPorj;
